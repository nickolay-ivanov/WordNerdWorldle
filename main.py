...
from wordle import key_pressed
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_RETURN:
                    ...
                    if key_pressed in "QWERTYUIOPASDFGHJKLZXCVBNM" and key_pressed != "":  # Check if user is typing
                        if len(current_guess_string) < 5:
                            create_new_letter()
                pygame.display.update()
        WORDLE_BACK = Button(image=None, pos=(800, 650),
...
def worldle():
    while True:
        ...
        WORLDLE_TEXT = get_font(45).render("Tuka she ima worldle.", True, "Black")
